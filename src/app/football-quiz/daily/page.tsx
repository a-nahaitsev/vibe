...
import { QuestionCard, AnswerOptions, StreakBadge, Leaderboard } from "@/components/quiz";
  ...
  if (questions.length === 0) {
    return (
      <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-900/20">
        ...
        <Link href="/football-quiz" className="mt-2 inline-block text-emerald-600 dark:text-emerald-400">
          ← Back to Home
        </Link>
      </div>
    );
